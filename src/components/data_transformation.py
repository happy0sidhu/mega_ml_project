...
class datatransformationconfig:
    # yaha pe input wale configurations v krni hai
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("numerical dtaa trans completed ")
            ...
            logging.info("ctaegorical enoding completed ")

            preprocessor=ColumnTransformer([
                ("nnumerical_pipeline",num_pipeline,numerical_features),
                ("categorical piupeline",cat_pipeline,categorical_features)
            ])
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info("read train and test data in transf  block")
